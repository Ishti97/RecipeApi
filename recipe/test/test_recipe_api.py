...
class PublicRecipeApiTests(TestCase):
    ...
    def test_login_required(self):
        """Test the autnetication is required"""
...
class PrivateRecipeApiTests(TestCase):
    """Test the authorized user for recipe api"""
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filters_recipes_by_tags(self):
        """Test returning recipes with specific tags"""

        recipe1 = sample_recipe(user=self.user, title='Thai veg curry')
        recipe2 = sample_recipe(user=self.user, title='Auberbeg with Tahini')
        tag1 = sample_tag(user=self.user, name='Vegan')
    ...
    def test_filters_recipes_by_ingredients(self):
        """Test returning recipes with specific ingredients"""

        recipe1 = sample_recipe(user=self.user, title='Posh beans on toast')
        recipe2 = sample_recipe(user=self.user, title='Chicken caciatore')
